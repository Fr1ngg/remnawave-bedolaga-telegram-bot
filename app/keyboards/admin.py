...
def get_campaign_edit_keyboard(
    campaign_id: int, *, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text="🎁 Бонус",
                    callback_data=f"admin_campaign_edit_bonus_{campaign_id}",
                )
            ],
            [
                InlineKeyboardButton(
...
def get_campaign_bonus_edit_keyboard(
    campaign_id: int, *, language: str = "ru"
) -> InlineKeyboardMarkup:
    texts = get_texts(language)
        ...
        inline_keyboard=[
            [
                InlineKeyboardButton(
                    ...
                    callback_data=f"admin_campaign_edit_bonus_balance_{campaign_id}",
                )
            ],
            [
                InlineKeyboardButton(
                    text="📱 Подписка",
                    callback_data=f"admin_campaign_edit_bonus_subscription_{campaign_id}",
                )
            ],
            [
                InlineKeyboardButton(
