...
DEFAULT_TEMPLATES: tuple[dict, ...] = (
    ...
    },
    {
        ...
        "message_text": (
            ...
            "Активируйте предложение, и скидка автоматически применится при продлении.\n"
    ...
    },
    {
        ...
        "message_text": (
            ...
            "Нажмите «Забрать скидку», и она применится при оплате новой подписки.\n"
            "Скидка суммируется с промогруппой и действует {valid_hours} ч."
        ),
